...
<div class="search-box col-md-5">
    <div class="input-group mb-3">
        <div class="input-group-prepend">
            ...
            aria-haspopup="true" aria-expanded="false" id="choice" value="제목">제목</button>                        
...
<% for(int i=0; i< (int)((board_size-1)/20)+1; i++){
	%>	
<a href="board_ENTP.do?page=<%=i+1%>"><%=i+1%></a> 
<%
}
%>
</div>
...
function searchBoard(){
	...
	location.href="board_ENTP.do?page=1&choice=" + choice + "&search=" + search; /
}
