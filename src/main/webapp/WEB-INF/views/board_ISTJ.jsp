...
%>
		...
		%>
		<tr>
			<td colspan="6">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp삭제된 글입니다.</td>
		</tr>
		<%
		}
			else{			
...
<% for(int i=0; i< (int)((board_size-1)/20)+1; i++){
	%>	
<a href="board_ISTJ.do?page=<%=i+1%>"><%=i+1%></a> <!-- 바꿔야함 EX)board_free.do?page -->
<%
}
%>
</div>
...
<br>
<div align="center">
	<a href="board_write.do?boardtype=0" class="btn btn-primary pull-right">글쓰기</a>	<!-- 각자의 넘버로 바꾸기 -->
</div>
</div>
...
function searchBoard(){
	...
	location.href="board_ISTJ.do?page=1&choice=" + choice + "&search=" + search; 
}
