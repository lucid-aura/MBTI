	...
	<header>
		<nav>
			<div class="fixed-top py-3 px-3 bg-dark text-center" id="nav">
				...
				<a href="board_ENTJ.do?page=1" class="text-light distance">유형별게시판</a> <!-- 바꿔야함 -->
...
<% for(int i=0; i< (int)((board_size-1)/20)+1; i++){
	%>	
<a href="board_ENTJ.do?page=<%=i+1%>"><%=i+1%></a> <!-- 바꿔야함 EX)board_free.do?page -->
<%
}
%>
</div>
...
<br>
<div align="center">
	<a href="board_write.do?boardtype=15" class="btn btn-primary pull-right">글쓰기</a>	<!-- 각자의 넘버로 바꾸기 -->
</div>
<!--  117 131 제목 바꾸기-->
<!-- 
...
function searchBoard(){
	...
	location.href="board_ENTJ.do?page=1&choice=" + choice + "&search=" + search; //각자의 컨트롤러로 바꾸기
}
</script>
