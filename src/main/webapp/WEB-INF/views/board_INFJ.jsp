...
<% for(int i=0; i< (int)((board_size-1)/20)+1; i++){
	%>	
<a href="board_INFJ.do?page=<%=i+1%>"><%=i+1%></a> 
<%
}
%>
</div>
...
<br>
<div align="center">
	<a href="board_write.do?boardtype=4" class="btn btn-primary pull-right">글쓰기</a>	
</div>
</div>
<br><br><br><br>
...
function searchBoard(){
	...
	location.href="board_INFJ.do?page=1&choice=" + choice + "&search=" + search; 
}
